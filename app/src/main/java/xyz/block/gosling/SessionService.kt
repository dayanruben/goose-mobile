...
class SessionService : VoiceInteractionSessionService() {
    ...
    private class Session(context: Context) : VoiceInteractionSession(context) {
        ...
        override fun onShow(args: Bundle?, showFlags: Int) {
            ...
            Log.d("GOS", "starting goslingassitant")
        ...
        private fun startSpeechRecognition() {
            ...
            speechRecognizer?.setRecognitionListener(object : RecognitionListener {
                override fun onResults(results: Bundle?) {
                    val voiceCommand = results?.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION)?.firstOrNull()
                ...
                override fun onPartialResults(partialResults: Bundle?) {
                    val voiceCommand = partialResults?.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION)?.firstOrNull()
                    if (!voiceCommand.isNullOrEmpty()) {
